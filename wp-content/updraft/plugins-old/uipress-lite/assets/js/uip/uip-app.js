...
//Import Vue modules
import * as uipAppDropdown from './modules/uip-dropdown.min.js?version=310';
import * as uipAppMultiSelect from './modules/uip-multiselect.min.js?version=310';
import * as uipAppUserMultiSelect from './modules/uip-user-role-multiselect.min.js?version=310';
import * as uipAppAccordion from './modules/uip-accordion.min.js?version=310';
import * as uipAppSwitchToggle from './modules/uip-switch-toggle.min.js?version=310';
import * as uipAppTooltip from './modules/uip-tooltip.min.js?version=310';
import * as uipAppChartLoading from './modules/uip-loading-chart.min.js?version=310';
import * as uipAppOffcanvas from './modules/uip-offcanvas.min.js?version=310';
import * as uipAppBlockContainer from './modules/uip-prod-block-container.min.js?version=310';
import * as uipAppContentArea from './modules/uip-content-area.min.js?version=310';
import * as uipAppChart from './modules/uip-chart.min.js?version=310';
import * as uipAppModal from './modules/uip-modal.min.js?version=310';
import * as uipAppSaveButton from './modules/uip-save-button.min.js?version=310';
import * as uipAppColorPicker from './options/uip-color-picker.min.js?version=310';

//Import main ui view
import * as uipMainView from './modules/uip-app-view.min.js?version=310';

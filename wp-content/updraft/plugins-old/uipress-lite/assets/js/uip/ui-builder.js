...
import { uip } from './classes/uip.min.js?version=310';
import { uipMediaLibrary } from './classes/uip-media-library.min.js?version=310';
const uipress = new uip('builder');

///Blocks groups
//Register block settings groups
import * as blockGroups from './blocks/block-settings-groups.min.js?version=310';
uipress.register_new_block_groups(blockGroups.fetchGroups());
//Import blocks
import * as elementBlocks from './blocks/elements/loader.min.js?version=310';
import * as layoutBlocks from './blocks/layout/loader.min.js?version=310';
import * as formBlockOptions from './blocks/inputs/loader.min.js?version=310';
import * as dynamicBlocks from './blocks/dynamic/loader.min.js?version=310';
import * as analyticsBlocks from './blocks/analytics/loader.min.js?version=310';
import * as storeAnalyticsBlocks from './blocks/storeanalytics/loader.min.js?version=310';
...
//Dynamic settings
import * as UIPDynamicss from './options/dynamic-settings.min.js?version=310';
...
///Block settings
import * as UIPsettings from './options/settings-loader.min.js?version=310';
...
import * as UIPthemeStyles from './options/theme-styles.min.js?version=310';
...
import * as UIPtemplateSettings from './uibuilder/template-settings-groups.min.js?version=310';
...
import * as UIPGlobalSettingsGroups from './uibuilder/global-settings-groups.min.js?version=310';
...
///Builder components
import * as UIbuilderTable from './uibuilder/uip-template-list.min.js?version=310';
import * as UIBuilderFramework from './uibuilder/uip-builder-framework.min.js?version=310';

import * as UIbuilderSettings from './uibuilder/uip-builder-settings.min.js?version=310';
import * as UIbuilderPreview from './uibuilder/uip-ui-preview.min.js?version=310';
import * as UIbuilderblocksList from './uibuilder/uip-builder-blocks-list.min.js?version=310';
import * as UIbuilderPatternsList from './uibuilder/uip-builder-patterns-list.min.js?version=310';
import * as UIbuilderDropArea from './uibuilder/uip-builder-drop-area.min.js?version=310';
import * as UIbuilderTreeviewDropArea from './uibuilder/uip-treeview-drop-area.min.js?version=310';
import * as UIbuilderBlockContainer from './uibuilder/uip-block-container.min.js?version=310';
import * as UIbuilderBlockSettings from './uibuilder/uip-block-settings.min.js?version=310';
import * as UIbuilderHistory from './uibuilder/uip-builder-history.min.js?version=310';
import * as UIbuilderBlockActions from './uibuilder/uip-block-actions.min.js?version=310';
import * as UIbuilderLibrary from './uibuilder/uip-template-library.min.js?version=310';
import * as UIbuilderBlockSettingsLoader from './uibuilder/uip-settings-loader.min.js?version=310';
import * as UIbuilderVariablesList from './uibuilder/uip-builder-variables.min.js?version=310';
import * as UIbuilderSavePattern from './uibuilder/uip-save-pattern.min.js?version=310';
import * as UIbuilderGlobalSettings from './uibuilder/uip-builder-global-settings.min.js?version=310';
import * as UIbuilderSetupWizard from './uibuilder/uip-builder-setup-wizard.min.js?version=310';

//Tool import
import * as UIToolsErrroLog from './tools/uip-php-error-log.min.js?version=310';

//modules
import * as UIbuilderDropdown from './modules/uip-dropdown.min.js?version=310';
import * as UIbuilderMultiSelect from './modules/uip-multiselect.min.js?version=310';
import * as UIbuilderUserMultiSelect from './modules/uip-user-role-multiselect.min.js?version=310';
import * as UIbuilderUserSearch from './modules/uip-user-role-search.min.js?version=310';

import * as UIbuilderPostTypeMultiSelect from './modules/uip-post-type-select.min.js?version=310';
import * as UIbuilderPostMetaMultiSelect from './modules/uip-post-meta-select.min.js?version=310';
import * as UIbuilderAccordion from './modules/uip-accordion.min.js?version=310';
import * as UIbuilderSwitchToggle from './modules/uip-switch-toggle.min.js?version=310';
import * as UIbuilderTooltip from './modules/uip-tooltip.min.js?version=310';
import * as UIbuilderChartLoading from './modules/uip-loading-chart.min.js?version=310';
import * as UIbuilderOffcanvas from './modules/uip-offcanvas.min.js?version=310';
import * as UIbuilderSaveButton from './modules/uip-save-button.min.js?version=310';
import * as UIbuilderDynamicList from './modules/uip-dynamic-data-list.min.js?version=310';
import * as UIbuilderChart from './modules/uip-chart.min.js?version=310';
import * as UIbuilderModal from './modules/uip-modal.min.js?version=310';

//Option components
import * as UIbuilderImageSelect from './options/uip-image-select.min.js?version=310';
import * as UIbuilderBackgroundPosition from './options/uip-background-position.min.js?version=310';
import * as UIbuilderSwitch from './options/uip-switch-select.min.js?version=310';
import * as UIbuilderValueUnits from './options/uip-value-units.min.js?version=310';
import * as UIbuilderUnits from './options/uip-units.min.js?version=310';
import * as UIbuilderDimensions from './options/uip-dimensions.min.js?version=310';
import * as UIbuilderColorSelect from './options/uip-color-select.min.js?version=310';
import * as UIbuilderColorPicker from './options/uip-color-picker.min.js?version=310';
import * as UIbuilderBorder from './options/uip-border-designer.min.js?version=310';
import * as UIbuilderShadow from './options/uip-shadow-designer.min.js?version=310';
import * as UIbuilderInput from './options/uip-input.min.js?version=310';
import * as UIbuilderNumber from './options/uip-number.min.js';
import * as UIbuilderPostTypes from './options/uip-post-types.min.js?version=310';
import * as UIbuilderPostMeta from './options/uip-post-meta.min.js?version=310';
import * as UIbuilderParagraphInput from './options/uip-paragraph-input.min.js?version=310';
import * as UIbuilderDynamicInput from './options/uip-dynamic-input.min.js?version=310';
import * as UIbuilderPadding from './options/uip-padding.min.js?version=310';
import * as UIbuilderMargin from './options/uip-margin.min.js?version=310';
import * as UIbuilderIconSelect from './options/uip-icon-select.min.js?version=310';
import * as UIbuilderInlineIconSelect from './options/uip-inline-icon-select.min.js?version=310';
import * as UIbuilderChoiceSelect from './options/uip-choice-select.min.js?version=310';
import * as UIbuilderIconChoiceSelect from './options/uip-icon-choice-select.min.js?version=310';
import * as UIbuilderTextFormat from './options/uip-text-format.min.js?version=310';
import * as UIbuilderDefaultSelect from './options/uip-default-select.min.js?version=310';
import * as UIbuilderLinkSelect from './options/uip-link-select.min.js?version=310';
import * as UIbuilderBorderRadius from './options/uip-border-radius.min.js?version=310';
import * as UIbuilderTabBuilder from './options/uip-tab-builder.min.js?version=310';
import * as UIbuilderHiddenMenuItems from './options/uip-hidden-menu-items-select.min.js?version=310';
import * as UIbuilderHiddenToolbarItems from './options/uip-hidden-toolbar-items-select.min.js?version=310';
import * as UIbuilderEditToolbarItems from './options/uip-edit-toolbar-items.min.js?version=310';
import * as UIbuilderEditMenuItems from './options/uip-edit-menu-items.min.js?version=310';
import * as UIbuilderResponsive from './options/uip-responsive.min.js?version=310';
import * as UIbuilderMultiselectOption from './options/uip-multi-select.min.js?version=310';
import * as UIbuilderCodeEditor from './options/uip-code-editor.min.js?version=310';
import * as UIbuilderPositionEditor from './options/uip-position-designer.min.js?version=310';
import * as UIbuilderSubmitAction from './options/uip-submit-action.min.js?version=310';
import * as UIbuilderSelectOptionBuilder from './options/uip-select-option-builder.min.js?version=310';
import * as UIbuilderSimpleColorPicker from './options/uip-simple-color-picker.min.js?version=310';
import * as UIbuilderArrayList from './options/uip-array-list.min.js?version=310';
